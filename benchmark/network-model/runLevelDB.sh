...
# Tests
node ../../scripts/main.js -c ./benchmark/network-model/levelDB/empty-contract-1of.yaml -n ./network/fabric-v1.4/2org1peergoleveldb/fabric-node-1of.json;
node ../../scripts/main.js -c ./benchmark/network-model/levelDB/empty-contract-2of.yaml -n ./network/fabric-v1.4/2org1peergoleveldb/fabric-node.json;
